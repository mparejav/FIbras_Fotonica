...
def Intensidad(X_prima, Y_Prima, Nx, Ny, Distancia_Plano_Observación, Longitud_de_Onda, Apertura):
    ...
    elif Apertura == 'Rectangulo':  # Rectángulo
...
apertura = input("Seleccione el tipo de apertura (Borde/Rendija/Rectangulo): ")
if apertura not in ['Borde', 'Rendija', 'Rectangulo']:
    print("Apertura no válida. Por favor elija entre 'Borde', 'Rendija' o 'Rectangulo'.")
else:
