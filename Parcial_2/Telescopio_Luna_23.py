...
alpha_visto = 0.1127 # radianes

Distanca_Objeto = 385000000000 #mm
...
# s = Objeto_a_plano(Distanca_Objeto, D)
...
Mag_ang = Focos[0]/Focos[1]

alpha = alpha_visto/Mag_ang

radio_luna = Distanca_Objeto*np.tan(alpha/2) #mm

radio_luna = radio_luna/1000000 # mm to km
